...
public class GridView<State> extends StackPane {
    ...
    /**
     * This method initialized the filters that are needed for the mouse over click handler of the cell (see {@link eu.lestard.grid.Cell#setOnMouseOver(EventHandler)}.
     *
     *
     * @param pane
     * @param cell
